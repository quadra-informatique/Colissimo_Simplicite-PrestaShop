...
<div class="panel">
    <fieldset style="width:400px;">
        ...
        {else}
            ...
            <b>{l s='Customer' mod='colissimo_simplicite'} : </b>
            <span>{$address_delivery->firstname|escape:'html':'UTF-8'} {$address_delivery->lastname|escape:'html':'UTF-8'}</span><br /><br />
            ...
            {if $address_delivery->address2}
                {$address_delivery->address2|escape:'html':'UTF-8'}<br />
            {/if}
            {$address_delivery->postcode|escape:'html':'UTF-8'}  {$address_delivery->city|escape:'html':'UTF-8'}<br />
            {$address_delivery->country|escape:'html':'UTF-8'}<br />
            {$address_delivery->other|escape:'html':'UTF-8'}<br />
        {/if}
    </fieldset>
</div>